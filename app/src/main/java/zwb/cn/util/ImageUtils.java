...
public class ImageUtils {
     ...
     * @return
     * @see zwb.cn.util.ImageUtils#getInputStreamFromUrl(String, int, boolean)
     */
     ...
     * @param readTimeOutMillis
     * @return
     * @see zwb.cn.util.ImageUtils#getDrawableFromUrl(String, int, boolean)
     */
     ...
     * @param readTimeOut
     * @return
     * @see zwb.cn.util.ImageUtils#getBitmapFromUrl(String, int, boolean)
     */
