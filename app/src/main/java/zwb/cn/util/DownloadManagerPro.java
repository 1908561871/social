 ...
 * <li>{@link zwb.cn.util.DownloadManagerPro.RequestPro#setNotiClass(String)} set noti class</li>
 * <li>{@link zwb.cn.util.DownloadManagerPro.RequestPro#setNotiExtras(String)} set noti extras</li>
 * </ul>
 * 
