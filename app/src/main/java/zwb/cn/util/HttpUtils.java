...
import zwb.cn.config.HttpConstants;
import zwb.cn.entity.HttpRequest;
import zwb.cn.entity.HttpResponse;
 ...
 * <li>{@link #httpGet(HttpRequest, zwb.cn.util.HttpUtils.HttpListener)} http get asynchronous</li>
 * <li>{@link #httpGet(String, zwb.cn.util.HttpUtils.HttpListener)} http get asynchronous</li>
 * </ul>
 * <ul>
...
public class HttpUtils {
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see zwb.cn.util.HttpUtils#httpGet(HttpRequest)
     */
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see zwb.cn.util.HttpUtils#httpPost(HttpRequest)
     */
     ...
     *        {@link zwb.cn.util.HttpUtils#joinParas(java.util.Map)}
     * @return the content of the url, if null represents http error
     * @see zwb.cn.util.HttpUtils#httpPost(HttpRequest)
     */
