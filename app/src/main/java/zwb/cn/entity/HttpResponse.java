package zwb.cn.entity;

import java.util.HashMap;
import java.util.Map;

import zwb.cn.config.HttpConstants;
import zwb.cn.util.HttpUtils;
 ...
 * <li>{@link zwb.cn.entity.HttpResponse#HttpResponse()}</li>
 * <li>{@link zwb.cn.entity.HttpResponse#HttpResponse(String)}</li>
 * </ul>
 * <ul>
 * <strong>Get</strong>
